...
const TracingGame: React.FC<TracingGameProps> = ({ onExit }) => {
  ...
  return (
    <div className="min-h-[100svh] w-full flex flex-col items-center justify-center p-3 sm:p-4 text-center bg-gradient-to-b from-sky-50 to-blue-50 text-slate-800 overflow-x-hidden relative">
      <button
        onClick={onExit}
